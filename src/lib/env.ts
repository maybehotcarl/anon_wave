...
export function getServerEnv() {
  ...
  return {
    ...
    zkAttestationAudience: readEnv("ZK_ATTESTATION_AUDIENCE") ?? "anonwave.live",
    zkAttestationIssuer: readEnv("ZK_ATTESTATION_ISSUER") ?? "https://zkyc.solutions",
    zkAttestationPublicKeyB64: readEnv("ZK_ATTESTATION_PUBLIC_KEY_B64"),
